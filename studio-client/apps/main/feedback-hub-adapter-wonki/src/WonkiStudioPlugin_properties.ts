...
const WonkiStudioPlugin_properties: WonkiStudioPlugin_properties = {
  ...
  ghostwritr_loading_state_text: "Please have some patience while the AI generates the text.",
  ...
  transformr_empty_state_text: "The AI couldn't generate a result. Please try again later.",
  transformr_loading_state_title: "Optimizing ...",
  transformr_loading_state_text: "Please have some patience while the AI is processing your request.",
